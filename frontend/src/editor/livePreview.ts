...
export const livePreviewTheme = EditorView.baseTheme({
  ...
  ".cm-live-video-wrapper:-webkit-full-screen": {
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    background: "#000",
  ...
  ".cm-live-video-wrapper:-moz-full-screen": {
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    background: "#000",
  ...
  ".cm-live-video-wrapper:-webkit-full-screen .cm-live-video-iframe": {
    width: "100%",
    height: "100%",
    aspectRatio: "auto",
    borderRadius: "0",
  },
  ".cm-live-video-wrapper:-moz-full-screen .cm-live-video-iframe": {
    width: "100%",
    height: "100%",
    aspectRatio: "auto",
    borderRadius: "0",
